/*
  Ce programme permet de recpuerer des trames envoyées par un GPS et de les
  traiter afin d'en tirer des informations sur nottament des coordonnées,
  une température et une profondeur...
*/
...
void __fastcall TForm1::OuvrirPort1Click(TObject *Sender)
{
	...
	//affichage des Labels et des Mémos
	Label1->Visible = true;
	Label2->Visible = true;
	Label3->Visible = true;
	Label4->Visible = true;
...
// Traduction de la trame pour récuperer uniquement les coordonnées
void __fastcall TForm1::Timer1Timer(TObject *Sender)
{
	...
	for(int j = 0; j < trames.size(); j++)
	{
		...
		do
		{
        //Traitement de la trame GPGGA qui contient les valeurs des coordonnées
		// verification de la bonne trame puis découpage
